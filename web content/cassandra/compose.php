...
$record = array("to"=>"$to","from"=>"$from","subject"=>"$subject","content"=>"$content",
    ...
    if ($cassandra->InsertRecordArray("cms", $keyC, $record))
    {
		...
		echo"<span style='font-family:arial; font-size:10pt;color:black;'>Your message has been sent!</span><br />";
		echo"<span style='font-family:arial; font-size:10pt;color:black;'>To:</span>
