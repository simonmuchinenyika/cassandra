...
echo "Date";
echo"</td>";
echo"<td colspan='1' valign='top' width='1%' style='font-family:arial; font-size:10pt;color:black'>";
echo"&nbsp";
echo"</td>";
echo"<td colspan='1' valign='top' width='5%' style='font-family:arial; font-size:10pt;color:black'>";
echo"  Action";
echo"</td>";
echo"</tr>";
